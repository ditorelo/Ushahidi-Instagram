...
class Socialmedia_Instagram_Install {
	/**
	 * Creates the required database tables for my_plugin_name
	 */
	public function run_install()
	{
		$twitter_service = ORM::factory("Service")->where("service_name", "SocialMedia Instagram")->find_all();

		if ($twitter_service->count() == 0) {
			$twitter_service = ORM::factory("Service");
			$twitter_service->service_name = "SocialMedia Instagram";
			$twitter_service->service_description = "Implements Instagram Crawling for Social Media plugin";
