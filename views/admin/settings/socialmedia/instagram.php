			...
			<div class="bg">
				...
				<div class="tabs">
					...
					<ul class="tabset">
						...
						if ($dispatch instanceof Dispatch) $run = $dispatch->method('subtabs', 'instagram');
						?>
					</ul>
					<!-- /tabset -->
				...
				<div class="report-form">
					...
					<div class="sms_holder">
						...
						<div class="row">
							<h4><?php echo Kohana::lang('instagram.client_id');?>:</h4>
							<?php print form::input('instagram_client_id', $form['instagram_client_id'], ' class="text long2"'); ?>
						</div>
						<div class="row">
							<h4><?php echo Kohana::lang('instagram.client_secret');?>:</h4>
							<?php print form::input('instagram_client_secret',$form['instagram_client_secret'],'class="text long2"'); ?>
						</div>
					</div>
				</div>
